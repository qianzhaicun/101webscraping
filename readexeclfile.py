# -*- coding: utf-8 -*-
"""
Created on Sat Sep  9 16:25:13 2017
...
drows = [d for d in drows if isinstance(d['CY 16 Enplanements'], float)]
# get biggest airport
airport = max(drows, key = lambda r: r['CY 16 Enplanements'])
print("%s: %i" % (airport['Airport Name'], airport['CY 16 Enplanements'] - airport['CY 15 Enplanements']))
# Hartsfield - Jackson Atlanta International: 849717

##https://www.faa.gov/airports/planning_capacity/passenger_allcargo_stats/passenger/media/preliminary-cy16-all-enplanements.xlsx